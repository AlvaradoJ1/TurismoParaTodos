...
@section('contenido')
    <script src="{{ asset('js/sitiosMegusta.js') }}" defer></script>
    ...
    <div class="sitios-container">
        <div class="cardC dark-mode-target">
            ...
            @foreach ($sitio->comentarios_sitios as $comentario)
                <div class="comments">
            ...
            <div class="text-box dark-mode-target">
                <div class="box-container dark-mode-target">
                    @if (Auth::check())
                        <form action="{{ route('comentarios.store.sitio', $sitio->id) }}" method="POST"
                            class="comment-form">
                            @csrf
